...
echo 'Blog';
echo '</h1>';
echo '<p>Discover different post of others</p>';
echo '</div>';
echo '</div>';
echo '</div>';
echo '</section>';
...
echo '<a href="#"><img class="img-responsive" src="img/blog/1.jpeg" alt=""></a>';
echo '<div class="blog-text">';
echo '<span class="user-post"><i class="ti-user"></i>Ema Madrigal</span>';
echo '<span class="date-post"><i class="ti-calendar"></i>April 28, 2022</span>';
echo '<span class="comment"><a href=""><i class="ti-comment"></i>5</a></span>';
echo '<p>Beachin... ready na ko mangitim >.<</p>';
echo '<a class="btn-blog" href="blog-post1.php">More Detail</a>';
echo '</div>';
echo '</div>';
echo '';
echo '<div class="blog-simple">';
echo '<a href="#"><img class="img-responsive" src="img/blog/2.jpeg" alt=""></a>';
echo '<div class="blog-text">';
echo '<span class="user-post"><i class="ti-user"></i>Ashley Saludo</span>';
echo '<span class="date-post"><i class="ti-calendar"></i>Dec. 15, 2021</span>';
echo '<span class="comment"><a href=""><i class="ti-comment"></i>6</a></span>';
echo '<p>Long time no sea <3</p>';
echo '<a class="btn-blog" href="blog-post2.php">More Detail</a>';
echo '</div>';
echo '</div>';
echo '';
echo '<div class="blog-simple">';
...
echo '<span class="comment"><a href=""><i class="ti-comment"></i>3</a></span>';
echo '<p>Ang hot!! ng panahon</p>';
echo '<a class="btn-blog" href="blog-post3.php">More Detail</a>';
echo '</div>';
echo '</div>';
echo '';
echo '<!-- Smaller pagination -->';
...
echo '<input type="text" id="search1" class="form-control" placeholder="search">';
