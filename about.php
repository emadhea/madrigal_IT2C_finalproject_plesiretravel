...
echo '<div>Call Us : +02151 7778 009</div>';
echo '</div>';
echo '</div>';
echo '</div>';
echo '';
...
echo '';
echo '<!-- section about -->';
echo '<section id="about-us-1" class="whitepage no-padding">';
echo '<div class="container-fluid">';
echo '<div class="row">';
echo '';
echo '<div class="image-container autoheight-1 col-lg-6 hidden-md hidden-sm hidden-xs pull-left onStep" data-animation="fadeInLeft" data-time="0"></div>';
echo '';
echo '<div class="col-lg-6 autoheight-1">';
echo '<div class="p-90">';
echo '<h2 class="big-heading space-title">';
echo 'A Perfect Place Vacation';
echo '<span class="devider-cont"></span>';
echo '</h2>';
echo '';
echo '<p class="intro">';
echo 'Marinduque is best known for the folk-religious festival celebrated during Holy Week where men and women in masks and costumes replicating the garb of biblical Roman soldiers, roam the streets. But aside from being a festive destination during the Lenten Season, Marinduque is a destination you can visit all year-around. Visit beaches and heritage sites, go food-tripping, enjoy the serene and laid-back island vibe and experience the warm and genuine hospitality from locals.';
echo '';
...
echo '';
echo '<!-- section about -->';
echo '<section id="about-us-2" class="no-padding whitepage">';
echo '<div class="container-fluid">';
echo '<div class="row">';
echo '';
echo '<div class="image-container autoheight-2 col-lg-6 hidden-md hidden-sm hidden-xs pull-right onStep" data-animation="fadeInRight" data-time="0"></div>';
echo '';
echo '<div class="col-lg-6 autoheight-2">';
echo '<div class="p-90">';
echo '<h2 class="big-heading space-title">';
...
echo '</h2>';
echo '';
echo '<p class="intro">Plesire Travel will help you find different tourist spots in the island of Marinduque. This will serve as your guide in choosing where to relax, chill, and unwind.</p>';
echo '';
echo '</div>';
echo '<div class="clearfix"></div>';
echo '</div>';
...
echo '';
echo '<!-- spacer -->';
echo '<div class="space-half"></div>';
echo '';
echo '<!-- team -->';
echo '<div class="onStep" data-animation="fadeInUp" data-time="300">';
echo '<div class="owl-carousel" id="owl-team">';
echo '';
echo '<div class="item">';
echo '<div class="team" style="background-image:url(img/owner.jpeg)">';
echo '<div class="hovereffect">';
echo '<div class="overlay-2">';
echo '<div class="content">';
echo '<div class="heading">Ema Madrigal';
echo '<span class="devider-recent-2"></span>';
echo '</div>';
echo '<div class="subheading">OWNER</div>';
