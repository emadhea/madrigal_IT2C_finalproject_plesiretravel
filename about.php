 ...
 <!-- section about end -->
               ...
               <div class="row">
                ...
                <div class="col-lg-6 autoheight-2">
                 <div class="p-90">
                  ...
                  <p class="intro">Plesire Travel will help you find different tourist spots in the island of Marinduque. This will serve as your guide in choosing where to relax, chill, and unwind.</p>
      ...
      <div class="container-fluid">
         ...
         <div class="owl-carousel" id="owl-team">
          ...
          <div class="item">
            <div class="team" style="background-image:url(img/owner.jpeg)">
                  <div class="hovereffect">
                    <div class="overlay-2">
                     <div class="content">
                     <div class="heading">Ema Madrigal
                     <span class="devider-recent-2"></span>
                     </div>
                     <div class="subheading">OWNER</div>
