...
echo '<span class="comment"><i class="ti-comment"></i> 6 </span>';
...
echo '<h5><span>Comments (6)</span></h5>';
echo '';
echo '<ul>';
echo '<li>';
echo '<div class="avatar"><img alt="img" src="img/blog/blogpost/avatar5.jpeg">';
echo '</div>';
echo '<div class="comment-info">';
echo '<span class="c-name">Christine Lopez</span>';
echo '<span class="c-date"><i class="ti-calendar"></i>16 Dec. 2021</span>';
echo '<span class="c-reply"><a class="link"  href="#">Reply</a></span>';
echo '</div>';
echo '<div class="comment">Sino ka jan?</div>';
echo '<!-- sub comment -->';
echo '<ul>';
echo '<li>';
...
echo '<span class="c-date">16 Dec. 2021</span>';
echo '<span class="c-reply"><a class="link"  href="#">Reply</a></span>';
echo '</div>';
echo '<div class="comment">Lisa Manoban bhie</div>';
echo '</li>';
echo '</ul>';
echo '<!-- sub comment end -->';
echo '</li>';
echo '</ul>';
echo '';
echo '';
...
echo '<span class="c-reply"><a class="link"  href="#">Reply</a></span>';
echo '</div>';
echo '<div class="comment">Aba</div>';
echo '</li>';
echo '</ul>';
echo '';
echo '<ul>';
echo '<li>';
echo '<div class="avatar"><img alt="img" src="img/blog/blogpost/avatar1.jpeg">';
echo '</div>';
echo '<div class="comment-info">';
echo '<span class="c-name">Justine Solito</span>';
echo '<span class="c-date">18 Dec. 2021</span>';
echo '<span class="c-reply"><a class="link"  href="#">Reply</a></span>';
echo '</div>';
echo '<div class="comment">Mine HAHAHAHHAHA</div>';
echo '</li>';
echo '</ul>';
echo '';
echo '<ul>';
...
echo '<span class="c-date">20 Dec. 2021</span>';
echo '<span class="c-reply"><a class="link"  href="#">Reply</a></span>';
echo '</div>';
echo '<div class="comment">Sana ol</div>';
echo '</li>';
echo '</ul>';
echo '';
echo '<ul>';
echo '<li>';
echo '<div class="avatar"><img alt="img" src="img/blog/blogpost/avatar2.jpeg">';
echo '</div>';
echo '<div class="comment-info">';
echo '<span class="c-name">Corey Taylor</span>';
echo '<span class="c-date">21 Dec. 2021</span>';
echo '<span class="c-reply"><a class="link"  href="#">Reply</a></span>';
echo '</div>';
echo '<div class="comment">Grabe naman yon!</div>';
echo '</li>';
echo '</ul>';
echo '';
