        ...
        <div class="container-fluid m-5-hor">
          <div class="row">
            <div class="col-md-12">
              ...
              <p>A place for vacations and recreation</p>
            </div>
        </div>
       </div>
      </section>
              ...
              <div class="row">
                ...
                <div class="gal-home">
                  <div class="hovereffect">
                    <img alt="imageportofolio" class="img-responsive" src="img/resort/freedomeco.jpeg">
                  </div>
                  <div class="gal-home-content">
                    <div class="row">
                         <div class="col-md-8"> 
                          <h4 class="autoheight">Freedom Eco Adventure Park</h4>
                          <div class="star-content">
                           ...
                           <div class="review-cont big-heading">376 Reviews</div>
                         </div>
                   </div>
                  </div>
                  </a>
                ...
                <div class="gal-home">
                        <div class="hovereffect">
                          <img alt="imageportofolio" class="img-responsive" src="img/resort/hidden.jpeg">
                        </div>
                        <div class="gal-home-content">
                          <div class="row">
                               <div class="col-md-8"> 
                                <h4 class="autoheight">Hidden Greenery Resort and Event Place</h4>
                                <div class="star-content">
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="gal-home">
                        <div class="hovereffect">
                          <img alt="imageportofolio" class="img-responsive" src="img/resort/luxorrar.jpeg">
                        </div>
                        <div class="gal-home-content">
                          <div class="row">
                               <div class="col-md-8"> 
                                <h4 class="autoheight">Luxor Resort and Restaurant</h4>
                                <div class="star-content">
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                 ...
                                 <div class="review-cont big-heading">298 Reviews</div>
                               </div>
                         </div>
                        </div>
                        </a>
                ...
                <div class="gal-home">
                        <div class="hovereffect">
                          <img alt="imageportofolio" class="img-responsive" src="img/resort/pinkystaha.jpeg">
                        </div>
                        <div class="gal-home-content">
                          <div class="row">
                               <div class="col-md-8"> 
                                <h4 class="autoheight">Pinky's Taha</h4>
                                <div class="star-content">
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                 ...
                                 <div class="review-cont big-heading">354 Reviews</div>
                               </div>
                         </div>
                        </div>
                        </a>
                ...
                <div class="gal-home">
                  <div class="hovereffect">
                    <img alt="imageportofolio" class="img-responsive" src="img/resort/sweetlips.jpeg">
                  </div>
                  <div class="gal-home-content">
                    <div class="row">
                         <div class="col-md-8"> 
                          <h4 class="autoheight">Sweet Lips</h4>
                          <div class="star-content">
                            <i class="fa fa-star" aria-hidden="true"></i> 
                            <i class="fa fa-star" aria-hidden="true"></i> 
                            <i class="fa fa-star" aria-hidden="true"></i> 
                ...
                <div class="gal-home">
                        <div class="hovereffect">
                          <img alt="imageportofolio" class="img-responsive" src="img/resort/villadarco.jpeg">
                        </div>
                        <div class="gal-home-content">
                          <div class="row">
                               <div class="col-md-8"> 
                                <h4 class="autoheight">Villa 'd Arco</h4>
                                <div class="star-content">
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                  <i class="fa fa-star" aria-hidden="true"></i> 
                                 ...
                                 <div class="review-cont big-heading">390 Reviews</div>
                               </div>
                         </div>
                        </div>
                        </a>
             ...
             <h4>Latest Destination</h4>
              <div class="tag-country">
                <a href="#" class="list-country">
                  Gasan <sup>300 visits</sup>
                </a>
                <a href="#" class="list-country">
                  Buenavista <sup>273 visits</sup>
                </a>
                <a href="#" class="list-country">
                  Boac <sup>251 visits</sup>
                </a>
              </div>
            </div>  
           </div>
