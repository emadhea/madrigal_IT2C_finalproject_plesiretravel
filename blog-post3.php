...
echo 'More Detail';
echo '</h1>';
echo '<p>See comments and replies</p>';
echo '</div>';
echo '</div>';
echo '</div>';
echo '</section>';
...
echo '';
echo '<!-- section -->';
echo '<section aria-label="section-blog" id="content">';
echo '<div class="container-fluid m-5-hor">';
echo '<div class="row">';
echo '';
echo '<!-- left content -->';
...
echo '<a href="#"><img class="img-responsive" src="img/blog/3.jpeg" alt=""></a>';
echo '<div class="blog-text">';
echo '<span class="user-post"><i class="ti-user"></i>Justine Solito</span>';
echo '<span class="date-post"><i class="ti-calendar"></i>Feb. 23, 2022</span>';
echo '<span class="comment"><i class="ti-comment"></i> 3 </span>';
echo '<p>Ang hot!! ng panahon</p>';
echo '';
echo '</div>';
echo '</div>';
echo '</article>';
...
echo '<h5><span>Comments (3)</span></h5>';
echo '';
echo '<ul>';
echo '<li>';
echo '<div class="avatar"><img alt="img" src="img/blog/blogpost/avatar6.jpeg">';
echo '</div>';
echo '<div class="comment-info">';
echo '<span class="c-name">Reynan Yap</span>';
echo '<span class="c-date"><i class="ti-calendar"></i>23 Feb. 2022</span>';
echo '<span class="c-reply"><a class="link"  href="#">Reply</a></span>';
echo '</div>';
echo '<div class="comment">Ang hot nga, ng panahon hahahaha</div>';
echo '</li>';
echo '</ul>';
echo '';
echo '';
echo '<ul>';
echo '<li>';
echo '<div class="avatar"><img alt="img" src="img/blog/blogpost/avatar3.jpeg">';
echo '</div>';
echo '<div class="comment-info">';
echo '<span class="c-name">Ema Madrigal</span>';
echo '<span class="c-date">23 Feb. 2022</span>';
echo '<span class="c-reply"><a class="link"  href="#">Reply</a></span>';
echo '</div>';
echo '<div class="comment">San yan?</div>';
echo '</li>';
echo '</ul>';
echo '';
echo '<ul>';
echo '<li>';
echo '<div class="avatar"><img alt="img" src="img/blog/blogpost/avatar4.jpeg">';
echo '</div>';
echo '<div class="comment-info">';
echo '<span class="c-name">Ashley Saludo</span>';
echo '<span class="c-date">25 Feb. 2022</span>';
echo '<span class="c-reply"><a class="link"  href="#">Reply</a></span>';
echo '</div>';
echo '<div class="comment">Aba naganun pa</div>';
echo '</li>';
echo '</ul>';
echo '';
echo '<div id="comment-form-wrapper">';
echo '<h6>Leave a Comment</h6>';
echo '<form class="no-smoothState" id="commentform" name="form1" method="post" action="#">';
echo '<textarea cols="10" rows="10" name="message" id="messagecom" placeholder="Comment"></textarea>';
echo '<input type="text" name="name" id="namecom" placeholder="name" />';
echo '<input type="text" name="email" id="emailcom" placeholder="email" />';
echo '<button id="sendcomment" class="btn" type="submit">Post Comment</button>';
echo '</form>';
echo '</div>';
echo '</div>';
echo '<!-- comment blog end -->';
echo '';
echo '</div>';
echo '<!-- left content end -->';
echo '';
echo '<!-- right content -->';
...
echo '<form class="no-smoothState" role="search">';
echo '<div class="input-group">';
echo '<input type="text" id="search" class="form-control" placeholder="search">';
echo '<div class="input-group-btn">';
echo '<button type="submit"><span class="icon"><i class="fa fa-search"></i></span></button>';
echo '</div>';
echo '</div>';
echo '</form>';
echo '</div>';
...
echo '</h5>';
echo '';
echo '<div class="devider-widget">';
echo '</div>';
echo '';
echo '<div class="recent">';
echo '<div>';
echo '<img alt="#" class="pull-left" src="img/blog/recent/1.jpeg">';
echo '<h6>';
echo '<a href="#">Justine Solito</a>';
echo '</h6>';
echo '<p>';
echo 'All i need is a good dose of vitamin sea';
echo '</p>';
echo '</div>';
echo '';
echo '<div>';
echo '<a href="#"><img alt="#" class="pull-left" src="img/blog/recent/2.jpeg"></a>';
echo '<h6>';
echo '<a href="#">Juan Cruz</a>';
echo '</h6>';
echo '';
echo '<p>';
echo 'The ocean made me salty';
echo '</p>';
echo '</div>';
echo '';
echo '<div>';
echo '<a href="#"><img alt="#" class="pull-left" src="img/blog/recent/3.jpeg"></a>';
echo '<h6>';
echo '<a href="#">Justine Solito</a>';
echo '</h6>';
echo '';
echo '<p>';
echo 'No one likes shady beaches';
echo '</p>';
echo '</div>';
echo '</div>';
echo '</div>';
...
echo '<input type="password" class="form-control" required>';
echo '</div>';
echo '<div class="form-group">';
