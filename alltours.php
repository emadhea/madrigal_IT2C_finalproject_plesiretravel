...
echo 'All Tours';
echo '</h1>';
echo '<p>See different spots in Marinduque</p>';
echo '</div>';
echo '</div>';
echo '</div>';
echo '</section>';
...
echo '<section aria-label="works" id="projects">';
...
echo '<!-- filter project -->';
echo '<ul id="filter-hide" class="init">';
echo '<li class="filtter-icon"><i class="ti-layout-grid3-alt"></i>';
echo '</li>';
echo '</ul>';
echo '';
echo '<!-- filter project end -->';
echo '';
echo '<div id="w-gallery-container" class="w-gallery-container">';
echo '';
echo '<div class="w-gallery .alltours">';
echo '<div class="projects-grid">';
echo '<div class="hovereffect-color">';
echo '<img src="img/all-tours/1.jpeg" alt="" class="w-gallery-image">';
echo '<div class="overlay">';
echo '<div class="v-align wrap">';
echo '</div>';
echo '</div>';
echo '</div>';
echo '</div>';
echo '</div>';
echo '';
echo '<div class="w-gallery .gasan">';
echo '<div class="projects-grid">';
echo '<div class="hovereffect-color">';
echo '<img src="img/all-tours/2.jpeg" alt="" class="w-gallery-image">';
echo '<div class="overlay">';
echo '<div class="v-align wrap">';
echo '</div>';
echo '</div>';
...
echo '</div>';
echo '';
echo '<div class="w-gallery .stcruz">';
echo '<div class="projects-grid">';
echo '<div class="hovereffect-color">';
echo '<img src="img/all-tours/3.jpeg" alt="" class="w-gallery-image">';
echo '<div class="overlay">';
echo '<div class="v-align wrap">';
echo '</div>';
echo '</div>';
...
echo '';
echo '<div class="w-gallery .gasan">';
echo '<div class="projects-grid onStep" data-animation="fadeInUp" data-time="0">';
echo '<div class="hovereffect-color">';
echo '<img src="img/all-tours/4.jpeg" alt="" class="w-gallery-image">';
echo '<div class="overlay">';
echo '<div class="v-align wrap">';
echo '</div>';
echo '</div>';
...
echo '</div>';
echo '';
echo '<div class="w-gallery .buena">';
echo '<div class="projects-grid onStep" data-animation="fadeInUp" data-time="0">';
echo '<div class="hovereffect-color">';
echo '<img src="img/all-tours/5.jpeg" alt="" class="w-gallery-image">';
echo '<div class="overlay">';
echo '<div class="v-align wrap">';
echo '</div>';
echo '</div>';
...
echo '<div class="projects-grid onStep" data-animation="fadeInUp" data-time="0">';
echo '<div class="hovereffect-color">';
echo '<img src="img/all-tours/6.jpeg" alt="" class="w-gallery-image">';
echo '<div class="overlay">';
echo '<div class="v-align wrap">';
echo '</div>';
echo '</div>';
...
echo '</div>';
echo '';
echo '<div class="w-gallery .mogpog">';
echo '<div class="projects-grid onStep" data-animation="fadeInUp" data-time="0">';
echo '<div class="hovereffect-color">';
echo '<img src="img/all-tours/7.jpeg" alt="" class="w-gallery-image">';
echo '<div class="overlay">';
echo '<div class="v-align wrap">';
echo '</div>';
echo '</div>';
...
echo '<div class="projects-grid onStep" data-animation="fadeInUp" data-time="0">';
echo '<div class="hovereffect-color">';
echo '<img src="img/all-tours/8.jpeg" alt="" class="w-gallery-image">';
echo '<div class="overlay">';
echo '<div class="v-align wrap">';
echo '</div>';
echo '</div>';
...
echo '<div class="projects-grid onStep" data-animation="fadeInUp" data-time="0">';
echo '<div class="hovereffect-color">';
echo '<img src="img/all-tours/9.jpeg" alt="" class="w-gallery-image">';
echo '<div class="overlay">';
echo '<div class="v-align wrap">';
echo '</div>';
echo '</div>';
